...
class NFLScraper(webdriver.Firefox):
    ...
    def openBarstool(self) -> None:
        self.get("https://www.barstoolsportsbook.com/sports/american_football/nfl")
...
with NFLScraper() as nfl:
    ...
    nfl.scrapGames(["Total Passing Yards By The Player",
                    "Total Receiving Yards By The Player",
                    "Total Receptions By The Player", "Total Rushing Yards By The Player",
